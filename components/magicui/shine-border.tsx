...
export default function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid min-h-[60px] w-fit min-w-[300px] place-items-center rounded-[--border-radius] bg-white p-0.5 text-black dark:bg-black dark:text-white",
        className,
      )}
    >
      <div
      ...
      <div
        className={cn(
          "z-[1] h-full w-full rounded-[--border-radius] bg-white text-black dark:bg-black dark:text-white p-3",
        )}
      >
        {children}
      </div>
